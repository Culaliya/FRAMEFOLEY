...
| Final public video accessible without login | **UNVERIFIED** | The master exists locally; the owner still needs to upload it to YouTube/Vimeo and verify logged-out playback. |
...
| Deployed commit recorded | **OWNER-VERIFIED** | Render Web and API both reported `8f5a8ef`; public API reported the full commit `8f5a8efc0f4b3f60395f97bcc415be3d109f9966`. |
